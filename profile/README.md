...
- **[Starter](https://github.com/open-amos/starter)** — Thin orchestrator that ties AMOS Core and Source Example together  
...
- Documentation (work in progress): [https://docs.amos.tech](https://docs.amos.tech) 
